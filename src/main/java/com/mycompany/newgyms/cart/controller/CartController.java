...
public interface CartController {
	...
	public @ResponseBody String addProductInCart(@RequestParam("product_id") int product_id,@RequestParam("cart_option_name") String cart_option_name, @RequestParam("cart_option_price") String cart_option_price, HttpServletRequest request, HttpServletResponse response)  throws Exception;
	/* 
