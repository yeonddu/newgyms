						...
						<table id="event_table" align=center>
							...
							<!-- 이벤트 기간 -->
								...
								<td align=left rowspan="2"><input type="date"
									name="event_start_date" class="event_inputbox" value="${event.event_start_date}" required> ~ <input
									type="date" name="event_end_date" class="event_inputbox" value="${event.event_end_date}" required>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="2" align=left style="padding-left: 20px;"><input type="file"
									name="event_image" onchange="readURL(this);"></td>
							</tr>
							...
							<tr>
								<td align=left>
									...
									class="event_inputbox" maxlength="20"
									name="event_no" value="${event.event_no}" />
									<input type="hidden" size="10"
									class="event_inputbox" maxlength="20"
									name="product_id" value="${event.product_id}" />
									<input type="hidden" size="10"
									class="event_inputbox" maxlength="20"
									name="product_name" value="${event.product_name}" />
								</td>
							</tr>
						</table>
						<div align=center>
