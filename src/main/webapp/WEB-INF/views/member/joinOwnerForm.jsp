...
<body>
   ...
   <form action="${contextPath}/member/joinOwner.do?member_name=${member_name}" method="post">   
   <table id="join_table2">   
      ...
      <tr>
         ...
         <td>
            <input name="center_name" id="center_name" class="join_inputbox" type="text" size="25" maxlength="20" 
            pattern="[a-zA-Z가-힣]{1,20}" required title="사업장명을 영문 또는 한글로 입력해주세요." >
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <input name="owner_eid" id="owner_eid" class="join_inputbox" type="text" size="25" maxlength="10" 
      ...
      <tr>
         ...
         <td>
            <select name="owner_tel1" class="join_inputbox" required> 
               <option>02</option>
               <option>031</option>
               <option>032</option>
               <option>041</option>
            ...
            &nbsp;<input name="owner_tel2" class="join_inputbox" type="text" size="6" maxlength="3" pattern="[0-9]{3}" required title="중간번호 3자리를 숫자로 입력해주세요." > -
            &nbsp;<input name="owner_tel3" class="join_inputbox" type="text" size="6" maxlength="4" pattern="[0-9]{4}" required title="뒷번호 4자리를 숫자로 입력해주세요.">   
         </td>
      </tr>
