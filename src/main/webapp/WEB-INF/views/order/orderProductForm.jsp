...
$(document).ready(function() {
 ...
 /* 전액사용 체크박스 */
 $(document).ready(function() {
   $("#fn_all_use").click(function() {
      if($("#fn_all_use").is(":checked")) {
	   var str_orderPoint = $('#td_orderPoint').val();
	   var orderPoint = Number(str_orderPoint);
        $('#td_orderPoint_use').val(orderPoint);
	   }
	   else {
...
<body>
   <div class="con-min-width">
      <div class="con">
         ...
         <form action="${contextPath}/order/payToOrderProduct.do" method="post" name="myOrderList"> 
         <!-- 상품 정보   -->
         ...
         <table class="memberInfoTable">
            <tbody>
               <tr>
                  ...
                  <td>
	                  이름&nbsp;&nbsp;
	                  <input id="td_orderer_name" class="orderName" type="text" value="${orderer.member_name}" name="orderer_name" type="text" size="19" maxlength="10" pattern="[가-힣]{2,10}" required title="이름은 공백없이 한글로 입력해주세요." />
                  <br><br>
                  	전화번호&nbsp;&nbsp;
                  ...
                  <td>이용자</td>
                  <td> 
               		   이름&nbsp;&nbsp;<input id="td_receiver_name" class="receiverName" type="text" value="" name="receiver_name" required>
               		   <br><br>
                  	전화번호&nbsp;&nbsp;
                  ...
                  <td style="text-align:left;" >
                     <input type="checkbox" style="margin-right:5px;" id="sameInfo">구매자와 동일
                  </td>
               </tr>
         ...
         <table style="margin-bottom: 30px;">
            ...
            <tr>
               ...
               <td style="width:200px;">
                  <input id="td_orderPoint_use" class="pointInput" type="text" pattern="[0-9]{*}" style="margin-right: 5px;" value="">원
               </td>
               <td style="width:150px;">
            	   <input id="fn_all_use" type="checkbox" class="all_use_btn"> 전액사용    
               </td>
				<td style="text-align:left;">               
    ...
    <!-- 최종주문결제 -->
         ...
         <table>
            ...
            <tr>
                 ...
                 <td><span id="total_discount_price">0</span>원</td> <!-- 총 할인 금액 -->
                  ...
                  <c:if test="${isLogOn==true and not empty memberInfo }">  
                	  <td><fmt:formatNumber value="${total_product_point }" type="number" />원</td><!-- 해당상품 적립금 -->
                	</c:if>  
            </tr>
         </table>
         ...
         <table>
            ...
            <tr>
               ...
               <td>
                  ...
                  <input type="hidden" name="product_main_image" value="${item.product_main_image}">
                   <input type="hidden" name="product_option_name" value="${item.product_option_name}">
                   <input type="hidden" name="product_option_price" value="${item.product_option_price}">
                   <input type="hidden" name="product_price" value="${item.product_price}">
                   <input type="hidden" name="product_sales_price" value="${item.product_sales_price}">   
                </td>
                </c:forEach>
            </tr>
            </tbody>
         ...
         <!-- 버튼 -->
         <div class="submit">
            <button class="submit_btn1" type="submit" value="결제하기" id="order_btn">결제하기</button> 
